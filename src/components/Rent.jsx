...
import { alquilarPelicula } from "../actions/index";
...
function mapDispatchToProps(dispatch) {
  return {
    alquilarPelicula: article => dispatch(alquilarPelicula(article))
  };
}
              ...
              <div className="card border border-primary border border-secondary" >
                <div className="card-body text-center">
                  ...
                  <div className="mt-3 d-grid gap-2">
                    <button type="button" className="btn btn-primary btn-lg" onClick={() => alquilarPelicula({title: data.Title})}>Alquilar</button>
                  </div>
                  <div className="mt-3 d-grid gap-2">
